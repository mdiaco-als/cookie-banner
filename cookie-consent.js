...
function pushConsentEvent(eventName, consent) {
  ...
  console.log("[cookie-consent] pushed:", payload);
    ...
    var css = ""
      ...
      + "#cc-actions button{flex:1 1 0;min-width:0;white-space:normal;word-break:break-word;line-height:1.2;padding:12px 10px;margin:0;border-radius:8px;border:0;font-weight:700;cursor:pointer;font-size:14px;text-align:center}"
      + "#cc-accept{background:#2e7d32;color:#fff}"
      + "#cc-manage{background:#eaeaea;color:#0f172a}"
      ...
      + "@media (max-width:430px){#cc-actions button{font-size:13px;padding:11px 10px}}"
      + "@media (max-width:420px){#cc-actions button{font-size:13px;padding:10px 8px}}"
      + "@media (max-width:380px){#cc-actions button{font-size:12px;padding:10px 9px}}"
