...
(function () {
  ...
  try {
    ...
    var css = ""
      ...
      + "#cc-links{margin:1rem 0 .8rem;gap:12px;font-size:.8rem;justify-content:center}"
      ...
      + "#cc-links a{font-size:.75rem;padding:4px 8px;min-height:32px;display:inline-block}"
      ...
      + "#cc-links{gap:6px}"
      + "#cc-links a{font-size:.7rem;padding:3px 6px;min-height:30px}"
